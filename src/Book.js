        ...
        return (
            <div className="book">
                <div className="book-top">
                    ...
                    {!this.props.book.imageLinks && <div className="book-cover"></div>}
                    <div className="book-shelf-changer">
                        <select value={this.props.book.shelf} onChange={(e) => this.selectionChanged(e, this.props.book)}>
